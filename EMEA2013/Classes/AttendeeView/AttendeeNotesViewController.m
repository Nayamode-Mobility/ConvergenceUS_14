...
@interface AttendeeNotesViewController ()

@end

@implementation AttendeeNotesViewController
...
- (void)viewDidLoad
{
    ...
    {
        self.lblPageTitle.text = @"ATENDEE NOTES";
    }
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    self.arrNotes = [objNoteDB GetAttendeeNotes:self.objAttendee.strEmail];
...
- (IBAction)SyncNotes:(id)sender
{
    ...
    NSString *strMyNotes = [objNotesDB GetAttendeeNotesJSON];
    //NSLog(@"%@",strMyNotes);
    
    NSString *strURL = strAPI_URL;
    strURL = [strURL stringByAppendingString:strAPI_NOTES_SYNC_ATTENDEE_NOTES];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    switch (intTag)
    {
        case OPER_ADD_NOTE_LIST:
        {
            ...
            {
                NotesDB *objNotesDB = [NotesDB GetInstance];
                BOOL blnResult = [objNotesDB SetAttendeeNotes:objData];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        AttendeeTakeNotesViewController *controller = segue.destinationViewController;
        ...
        controller.objAttendee = self.objAttendee;
        controller.blnNew = NO;
    }
    else if([segue.identifier isEqualToString:@"TakeNotes"])
    {
        AttendeeTakeNotesViewController *controller = segue.destinationViewController;
