...
@interface VenuesViewController : UIViewController<UITableViewDataSource, UITableViewDelegate, BMMapViewDelegate, MFMailComposeViewControllerDelegate>
{
    BMMapView *mapView;
}
...
@property (nonatomic, strong) NSArray *venuesData;
