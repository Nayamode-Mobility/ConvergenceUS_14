//
//  MySheduleCustomCollectionViewCell.h
//  mgx2013
//
...
@interface MySheduleCustomCollectionViewCell : UICollectionViewCell<UICollectionViewDataSource, UICollectionViewDelegate, UIAlertViewDelegate>
{
}
